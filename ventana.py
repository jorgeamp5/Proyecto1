...
root.title("Ventana con ícono")
icono = tk.PhotoImage(file="img/libros_icono.png")
# Establecerlo como ícono de la ventana.
root.iconphoto(True, icono)


def ocultar_indicador_menu():
    lbl_indicador_libros.config()
    lbl_indicador_usuarios.config()

def cambiar_pagina(lbl_indicador, frame):
    ocultar_indicador_menu()
    #Color de indicador pero solo se muestra en libros y se queda pegado alli no se mueve
